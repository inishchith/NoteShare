...
public class Main {
	...
	public void initialize() {
		...
		frame.getContentPane().setBackground(new java.awt.Color(232,232,232));  //Whatever color
		...
		Image main_logo = new ImageIcon(this.getClass().getResource("/browser.png")).getImage();
